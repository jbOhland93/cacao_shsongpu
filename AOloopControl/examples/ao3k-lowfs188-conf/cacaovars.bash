...
export CACAO_LOOPNAME="lowfs188"
...
# input WFS stream
export CACAO_WFSSTREAM="lowfs_data"    # Hardware stream, connected to physical camera
export CACAO_WFSSTREAMSIM="lowfs_sim" # Simulation camera stream
