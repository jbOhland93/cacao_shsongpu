...
#
export CACAO_DMINDEX="03"    # Hardware DM - connected to physical DM
...
# input WFS stream
export CACAO_WFSSTREAM="kiwikiu"    # Hardware stream, connected to physical camera
export CACAO_WFSSTREAMSIM="kiwikiusim" # Simulation camera stream
