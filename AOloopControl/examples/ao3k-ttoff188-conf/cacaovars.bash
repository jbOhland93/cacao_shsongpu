...
export CACAO_LOOPNAME="ttoff188"
...
export CACAO_WFSSTREAM="bim188_float"    # Hardware stream, connected to physical camera
export CACAO_WFSSTREAMSIM="bim188_float" # Simulation camera stream
